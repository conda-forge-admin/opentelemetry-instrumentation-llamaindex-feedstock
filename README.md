...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-llamaindex-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-llamaindex-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-llamaindex
# for installing globally
pixi global install opentelemetry-instrumentation-llamaindex
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-llamaindex` available on your platform:
...
```
pixi search opentelemetry-instrumentation-llamaindex --channel conda-forge
```
